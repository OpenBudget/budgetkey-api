...
CONTROLLERS_SCRIPT = [
    ...
    *[
    ...
    ('get', dict(list_name=LISTNAME, permissions=PERMISSIONS, items=True, kind=None),
     dict(id=1, name=LISTNAME, items=CONTROLLERS_OUTITEMS, **LISTNOMETA)),
    ...
    ('get', dict(list_name=LISTNAME, permissions=PERMISSIONS, items=True, kind=None), dict(id=1, name=LISTNAME, items=[
    ...
    ('get', dict(list_name=None, permissions=PERMISSIONS, items=True, kind=LISTKIND), [
        dict(id=4, list_id=2, **ITEM),
    ]),
